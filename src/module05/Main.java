...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(controller.requestRooms(10000, 2, "Fairmont Grand Hotel", "Kiev"));
        System.out.println(controller.requestRooms(3400, 2, "Podol Plaza Hotel", "Kyiv"));
        System.out.println(controller.requestRooms(2500, 2, "IBIS Киев Центр", "Kiev"));
